...
COMBINATIONS_PATH="dataset_preparation/combinations_paper.json"
USE_WANDB=""
REDISPATCH_DATA="/home/jovyan/redispatch-ml-forecasting/data/redispatch_data_utc_23_feb_2026.csv"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  -c, --combinations FILE  Path to combinations JSON (default: dataset_preparation/combinations_paper.json)"
            echo "  --wandb                  Enable Weights & Biases upload"
            echo "  -r, --redispatch-data    Path to redispatch CSV data (default: data/redispatch_data_utc_23_feb_2026.csv)"
