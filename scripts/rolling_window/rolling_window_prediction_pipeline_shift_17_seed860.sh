...
for tso in "50Hertz" "Amprion" "TransnetBW"; do
    ...
    python3 -m training.circular_shift_prediction \
        ...
        --output-dir "outputs_shifted_targets_17_seed860/${tso,,}/basic_day_ahead_price_wind_pv_cross_border_production_consumption_bloomberg_sce/evaluation" \
        --model-dir "outputs_shifted_targets_17_seed860/${tso,,}/basic_day_ahead_price_wind_pv_cross_border_production_consumption_bloomberg_sce" \
